        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/work-1.jpg);">
        				<a href="properties-single1.php" class="icon d-flex align-items-center justify-content-center btn-custom">
        			...
        			<div class="text">
        				...
        				<h3 class="mb-0"><a href="properties-single1.php">Blue View Home</a></h3>
